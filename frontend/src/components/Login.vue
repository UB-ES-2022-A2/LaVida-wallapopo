        ...
        <div class="card-body">
          ...
          <div class="container">
            <div>
              ...
              <button class="btn btn-success btn-lg my-2" @click="redirectToRegistro()" style="width: 100%;">Create
                Account</button>
              <button class="btn btn-secondary btn-lg my-2" @click="redirectToHome()" style="width: 100%;">Back To
                Main</button>
            </div>
          </div>
        </div>

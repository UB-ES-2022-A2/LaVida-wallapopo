      ...
      <div>
        ...
        >
          <div class="px-3 py-2">
            ...
            <b-form-group label="Escoge una categoría:" label-for="bg-categorias" label-cols-sm="4" label-cols-lg="12">
              <b-form-select id="bg-categorias" v-model="categorias" :options="categorias"></b-form-select>
            </b-form-group>
            <hr/>

...
if os.name == 'nt':
    ...
    subprocess.run(['cmd', '/c', 'pytest', out + '/unit/test_account_validation.py'])
    subprocess.run(['cmd', '/c', 'pytest', out + '/unit/test_model_accounts.py'])
    subprocess.run(['cmd', '/c', 'pytest', out + '/unit/test_model_favourites.py'])
    subprocess.run(['cmd', '/c', 'pytest', out + '/unit/test_model_orders.py'])
    subprocess.run(['cmd', '/c', 'pytest', out + '/unit/test_model_products.py'])
    subprocess.run(['cmd', '/c', 'pytest', out + '/unit/test_model_reviews.py'])

    subprocess.run(['cmd', '/c', 'pytest', out + '/functional/test_accounts.py'])
    subprocess.run(['cmd', '/c', 'pytest', out + '/functional/test_favourites.py'])
    subprocess.run(['cmd', '/c', 'pytest', out + '/functional/test_orders.py'])

...
def test_login_post(_app):
    with _app.app_context():
        ...
        account_not_exist = requests.post(url + "API/login", json=json)
        ...
        blank_password = requests.post(url + "API/login", json=json)
        ...
        wrong_password = requests.post(url + "API/login", json=json)
